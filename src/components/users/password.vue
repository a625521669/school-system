            ...
            <div class="col-xs-12">
                <form id="userForm" class="form-horizontal" role="form">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">输入旧密码</label>
                        <div class="col-sm-9">
                            <input name="oldPassword" type="password" id="form-field-1" class="col-xs-10 col-sm-5">
                        </div>
                    </div>
                    <div class="form-group">
    ...
    export default {
        ...
        methods: {
            changePassword() {
                ...
                fetch(this.$store.state.apiBase + '/user/changepassword', {
                    method: 'POST',
                    body: data
                })
